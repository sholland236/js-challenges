...
export const celsiusToFahrenheit = (tempInCelsius) => {
  let tempInFah = tempInCelsius * (9/5) + 32;
  return (tempInCelsius + " degrees celsius is " + tempInFah + " degrees fahrenheit");
};
...
export const calculateLifetimeSupply = (snickersPerDay, age, maxAge) => {
  let snickersNeeded;
  let daysLeft = (365 * (maxAge - age));
  snickersNeeded = snickersPerDay * daysLeft;
...
export const getStudentSummary = (score, name) => {
  let yourScore = getGrade(score);
  switch (yourScore) {
    case "A": return "Congratulations " + name + "! You achieved a grade of A.";
    case "B": return "Well done " + name + "! You achieved a grade of B.";
    case "C": return "Nicely done " + name + "! You achieved a grade of C.";
    case "D": return "That's okay " + name + ". You achieved a grade of D.";
    case "E": return "Too bad " + name + ". You achieved a grade of E.";
    case "F": return "Sorry " + name + ". You achieved a grade of F. There's always next year.";
    default: return "My apologies " + name + ", there's been an error in processing your grade.";
  }
};
